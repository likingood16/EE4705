...
|---|---|---|---|---|
| Charansagar Ramanujam | A0301658E | Task 2: SLAM map, room waypoints, room navigation, multi-turn chat and command parser; integration of navigation, VLM and object approach in the chat; custom world launch; README | `maps/`, `config/room_waypoints.yaml`, `goto_room.py`, `terminal_chat.py`, `approach_controller.py`, `launch/custom_house.launch.py` | 20-utterance command-parser evaluation (`evaluation/command_parser_trials.csv`) |
